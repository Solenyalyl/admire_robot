...
REPLY = {
    ...
    '爸': ['这么魁梧的身材，这么潇洒的外表，老爸不是大老板才怪了呢！', '老爸每天在外工作幸苦了', '老爸每天脚踏实地，勤勤恳恳为家里做贡献', '老爸真是太牛逼了', '老爸是一个有责任、有担当的男人!'],
    '歌': ['老妹的歌声简直就是天籁之音'],
    '男朋友': ['你那么可爱肯定会有一个很好很好的人在等你！'],
    '妹': ['你就是我们的小天使', '龙女是一个积极向上的正能量仙女', '瀑布一般的长发，淡雅的连衣裙，标准的瓜子脸，聪明的杏仁眼，那稳重端庄的气质，再调皮的人见了你都会小心翼翼','你从小就流露出这样才华横溢的天资', '你的美丽怎能用简单的漂亮二字来形容，你真的是沉鱼落雁 闭月羞花 倾国倾城', '这世间怎么会有这么好看的人']
